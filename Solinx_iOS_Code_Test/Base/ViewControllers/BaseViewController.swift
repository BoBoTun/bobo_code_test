...
class BaseViewController: UIViewController {
    ...
    func setNavigationColor(){
        if #available(iOS 15, *) {
            ...
            appearance.titleTextAttributes = [NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): UIColor.secondary_color,NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 16)]
